        ...
        <Modal show={openModal} onClose={() => setOpenModal(false)} maxWidth='4xl'>
            <div className='flex flex-col p-6 w-[100%] max-h-[80vh] overflow-y-auto'>
                ...
                <div className='flex flex-col border border-border-gray rounded-lg p-4 mt-6'>
                    ...
                    <span className="text-sm text-[#00B4AD] font-bold py-2">{data?.personName || 'Albert'}</span>
                ...
                <button onClick={() => setOpenModal(false)} className='self-center mt-6 font-extrabold w-[70%] py-2 text-black justify-center items-center rounded-xl flex flex-row'>
                    Cancel
                </button>
            </div>
        </Modal>
