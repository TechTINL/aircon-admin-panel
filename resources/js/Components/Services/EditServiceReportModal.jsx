        ...
        <Modal show={openModal} onClose={() => setOpenModal(false)} maxWidth='3xl'>
            <div className='flex flex-col p-6 w-[100%] xl:max-w-[80vw] h-full max-h-[80vh] gap-4 overflow-y-auto'>
                <div className='flex justify-between items-center'>
                    <span className='text-[26px] font-bold text-black'>Edit Service Report</span>
                    <button className='self-end' onClick={() => setOpenModal(false)}>
                        <AiFillCloseCircle
                            className='text-[#BCBDC0] text-4xl'
                        />
                    </button>
                </div>

                <div className='flex flex-col gap-4'>
                    <span className='text-[20px] font-bold text-black'>Client Detail</span>
                    ...
                    <div className='flex flex-row gap-6'>
                        ...
                        <div className='flex flex-1 flex-col gap-2'>
                            <span className='text-[18px] font-bold text-black'>Sub-Client</span>
                            <Dropdown>
                                <Dropdown.Trigger>
                                    <span className="inline-flex rounded-md w-full h-full">
                                        ...
                                        >
                                            <span className='px-2 font-bold text-[14px]'>{selectedSubClient}</span>
                                            <AiFillCaretDown
                                                size={20}
                                                fontWeight={800}
                                            />
                                ...
                                <Dropdown.Content>
                                    <div className='w-full'>
                                        {
                                            subClients.map((d, i) => <button key={i} onClick={() => setSelectedSubClient(d.value)} className={`w-full ${selectedSubClient === d.value && 'bg-slate-300'}`}>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <Switch
                        ...
                        className={`${swichOn ? 'bg-secondary' : 'bg-gray-200'
                ...
                <div className='flex flex-col gap-4'>
                    <span className='text-[20px] font-bold text-black'>Service Report Detail</span>

                    <div className='flex flex-row gap-6'>
                        <div className='flex flex-1 flex-col gap-2'>
                            <span className='text-[18px] font-bold text-black'>Name of Service<span className='text-red-600'>*</span></span>
                            <Dropdown>
                                <Dropdown.Trigger>
                                    <span className="inline-flex rounded-md w-full h-full">
                                        <button
                                            ...
                                            className="inline-flex justify-between items-center w-full h-[40px] px-3 py-2 bg-bg-input-gray text-sm leading-4 font-medium text-border-gray rounded-xl hover:text-gray-700 focus:outline-none transition ease-in-out duration-150"
                                        >
                                            <span className='px-2 font-bold text-[14px]'>{selectedServiceName}</span>
                                            <AiFillCaretDown
                                                size={20}
                                                fontWeight={800}
                                            />
                                ...
                                <Dropdown.Content>
                                    {
                                        nameOfServices.map((d, i) => <button key={i} onClick={() => setSelectedServiceName(d.value)} className={selectedSubClient === d.value && 'bg-slate-300'}>
                                            <div className='px-4 py-2'>
                                                {d.label}
                                            </div>
                                            {i < subClients.length - 1 && < hr />}
                        ...
                        <div className='flex flex-initial flex-col gap-2'>
                            <span className='text-[18px] font-bold text-black'>Type of Service<span className='text-red-600'>*</span></span>
                            <TextInput
                    ...
                    <div className='flex flex-row gap-6'>
                        <div className='flex flex-1 flex-col gap-2'>
                            <span className='text-[18px] font-bold text-black'>Service Date <span className='text-red-600'>*</span></span>
                        ...
                        <div className='flex flex-1 flex-col gap-2'>
                            <span className='text-[18px] font-bold text-black'>Service Time <span className='text-red-600'>*</span></span>
                            <MDropDown
                                items={times}
                    ...
                    <div className='flex flex-row gap-6'>
                        <div className='flex flex-1 flex-col gap-2'>
                            <span className='text-[18px] font-bold text-black'>Contract ID</span>
                            <TextInput
                        ...
                        <div className='flex flex-1 flex-col gap-2'>
                            <span className='text-[18px] font-bold text-black'>Service Report ID</span>
                            <TextInput
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-row items-end gap-6'>
                        <div className='flex flex-1 flex-col gap-2'>
                            <span className='text-[18px] font-bold text-black'>Team Leader / Sub-Contractor</span>
                            <button className='rounded-xl h-[40px] bg-white border border-border-gray justify-between items-center px-4 flex'>
                        ...
                        <div className='flex flex-initial w-[200px] flex-col gap-2'>
                            <span className='text-[18px] font-bold text-black'>Technician Count</span>
                            <button className='rounded-xl h-[40px] bg-white border border-border-gray justify-between items-center px-4 flex'>
                                <div>{'2'}</div>
                                <AiFillCaretDown
                                    size={20}
                        ...
                        <div className='flex flex-1 flex-col gap-2'>
                            <span className='text-[18px] font-bold text-black'>Technician</span>
                            <button className='rounded-xl h-[40px] bg-white border border-border-gray justify-between items-center px-4 flex'>
                                <div>
                                    <div>hhhh</div>
                                </div>
                    ...
                    <div className='flex flex-1 flex-col gap-2'>
                        <span className='text-[18px] font-extrabold text-primary'>Task 1</span>
                        <button className='rounded-xl h-[40px] bg-white border border-border-gray justify-between items-center px-4 flex'>
                            <div>{'Cleaning and washing'}</div>
                            <AiFillCaretDown
                                size={20}
                ...
                <div className='flex flex-col gap-4'>
                    <div className='flex flex-1 flex-col gap-2'>
                        <span className='text-[18px] font-extrabold text-primary'>Task 2</span>
                        <button className='rounded-xl h-[40px] bg-white border border-border-gray justify-between items-center px-4 flex'>
                            <div>{'Cleaning and washing'}</div>
                            <AiFillCaretDown
                                size={20}
                ...
                <div className='flex flex-col gap-4'>
                    <span className='text-[18px] font-extrabold text-black'>Technical Service Report</span>
                    <div className='border border-bg-input-gray rounded-xl p-4'>
                        All 3 air cons are cleaned and washed successfully. Gas are also refilled without any issue. No need for any follow up.
                    </div>
                </div>
                <div className='flex flex-col gap-4'>
                    <span className='text-[18px] font-extrabold text-black'>Task Visitation Note</span>
                    <TextArea className='border border-bg-input-gray rounded-xl p-4' placeholder='Type visitation notes here' />
                </div>
                ...
                <div className='flex flex-row gap-4 text-[16px] text-black'>
                    <div className='flex flex-col flex-1 gap-4'>
                        <div className='text-[18px] font-extrabold text-black'>Client's Signature</div>
                        <div className='bg-bg-input-gray w-full min-h-[250px] rounded-xl flex justify-center items-center'>
                            <img src={SignatureImg} className='max-w-[80%] max-h-[80%] object-contain' />
                        </div>
                    </div>
                    <div className='flex flex-1 flex-col mt-4 gap-6 pl-6 font-extrabold'>
                        <div className='flex justify-between'>
                            ...
                            <Switch
                                ...
                                className={`${asPrivate ? 'bg-secondary' : 'bg-gray-200'
                                    } relative inline-flex h-6 w-11 items-center rounded-full`}

                            >
                                <span
                                    className={`${asPrivate ? 'translate-x-6' : 'translate-x-1'
                                        } inline-block h-4 w-4 transform rounded-full bg-white transition`}
                                />
                            </Switch>
                        </div>
                        <div className='flex justify-between'>
                            ...
                            <Switch
                                ...
                                className={`${requireFollowUp ? 'bg-secondary' : 'bg-gray-200'
                                    } relative inline-flex h-6 w-11 items-center rounded-full`}

                            >
                                <span
                                    className={`${requireFollowUp ? 'translate-x-6' : 'translate-x-1'
                                        } inline-block h-4 w-4 transform rounded-full bg-white transition`}
                                />
                            </Switch>
                        </div>
