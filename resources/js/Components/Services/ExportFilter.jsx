...
function ExportFilter({ onExport }) {
  return (
      ...
      <div className="flex border-border-gray border-b-[1px]">
        <div className="flex flex-col border-border-gray border-r-[1px]">
          <div className="flex flex-col flex-2 min-w-[200px] px-4 py-2 border-border-gray border-b-[1px] justify-center">
            <span className="text-indigo-800 font-bold text-[16px]">
              Time Range
            </span>
            <span className="text-border-gray text-[16px]">
              24 Sept - 2 Oct
            </span>
          </div>
        ...
        <div className="p-4">
          <Calendar selectRange showDoubleView />
        </div>
      </div>
