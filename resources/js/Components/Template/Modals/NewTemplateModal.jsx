        ...
        >
            <div className='flex flex-col p-8 text-black gap-4'>
                ...
                <div className='flex flex-col gap-2'>
                    <b className='text-[16px]'>{title} Name<span className='text-red-600'>*</span></b>
                    <TextInput
                    ...
                    />
                    {
                        title === 'Contract' &&
                        <div className='flex flex-col gap-2'>
                            <b className='text-[16px]'>Number of Service<span className='text-red-600'>*</span></b>
                            <TextInput
                                type='number'
                ...
                <div className='flex flex-col items-center justify-center mt-6 gap-4'>
                    <button className='bg-primary py-2 w-full max-w-[600px] rounded-xl text-white font-bold'>Save {title} Template</button>
