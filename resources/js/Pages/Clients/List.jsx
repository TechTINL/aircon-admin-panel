                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-4 my-1 max-w-[200px]">
                                                    <div className="flex flex-col justify-center">
                                                        ...
                                                        <span
                                                            className={`${item.contactPerson.type === 'Residential'
                                                                ? 'bg-primary'
                                                                : 'bg-secondary'
                                                ...
                                                >
                                                    <div className="flex text-primary flex-row items-center relative">
                                                        ...
                                                        <div
                                                            className={`${i === showSubClients ? 'flex flex-col' : 'hidden'
                                                                } absolute w-max text-white bg-[#838383] max-h-[200px] top-5 left-4 rounded-sm p-2 z-[${i + 400
                                                                }]`}
                                                        >
                                                            <button
