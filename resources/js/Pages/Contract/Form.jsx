...
import Service from '@/Components/Contract/Create/ServiceRequest/Service.jsx';
import TextArea from '@/Components/Shared/TextArea.jsx';
import TimePicker from '@/Components/Common/TimePicker.jsx';
import { RiDeleteBin6Line } from 'react-icons/ri';
import Task from '@/Components/Contract/Create/ServiceRequest/Task.jsx';
import { MdOutlineAddCircleOutline } from 'react-icons/md';
import SelectTemplateModal from '@/Components/Template/SelectTemplateModal.jsx';
    ...
    >
      <AuthenticatedLayout user={auth.user}>
        ...
        <div className="flex-auto flex flex-col m-6 gap-6">
          ...
          <p>Above is to test Rina's Calendar Isse UI (Temp fix will remove later)</p>
          <ContractDetails />
          <ServiceDetail />
          <Summary />
          <button
